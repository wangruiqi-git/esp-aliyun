...
//移植其它单片机,请修改下面的程序
/*GPIO14 -- RST*/
#define GPIO_RST_IO     GPIO_NUM_14
#define GPIO_RST_PIN_SEL  (1ULL<<GPIO_RST_IO)
//#define DS1302_RST_MUX PERIPHS_IO_MUX_MTMS_U
//#define DS1302_RST_GPIO 14
//#define DS1302_RST_FUNC FUNC_GPIO14

/*GPIO12 -- DTA*/
#define GPIO_DAT_IO     GPIO_NUM_16
#define GPIO_DAT_PIN_SEL  (1ULL<<GPIO_DAT_IO)
//#define DS1302_DAT_MUX PERIPHS_IO_MUX_MTDI_U
//#define DS1302_DAT_GPIO 12
//#define DS1302_DAT_FUNC FUNC_GPIO12

/*GPIO13 -- CLK*/
#define GPIO_CLK_IO     GPIO_NUM_5
#define GPIO_CLK_PIN_SEL  (1ULL<<GPIO_CLK_IO)
